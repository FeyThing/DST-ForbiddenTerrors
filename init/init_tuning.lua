...
local DF_TUNING = {
	...
	DF_FOG_COOLDOWNS = {min = 3 * total_day_time, max = 8 * total_day_time},
	...
	DF_SCYTHER_HEALTH = 400,
	DF_SCYTHER_DAMAGE = 30,
	DF_SCYTHER_ATTACK_PERIOD = 2,
	DF_SCYTHER_MAX_TP_DISTANCE = 12,
