...
local events = {
    ...
    EventHandler("teleport_to_sea", function(inst)
...
local states = {
    ...
    State{
        ...
        timeline = {
            TimeEvent(20*FRAMES, function(inst) PlayExtendedSound(inst, "attack") end),
    ...
    State{
        ...
        events = {
            EventHandler("animover", function(inst)
                local offset = FindSwimmableOffset(inst:GetPosition(), TWOPI * math.random(), 10, 12)
    ...
    State{
        ...
        {
            EventHandler("animqueueover", function(inst)
                inst:ExchangeWithShadowCreature()
                inst:Remove()
            end),
        },
    },
...
return StateGraph("df_shadowcreature_sea", states, events, "appear", actionhandlers)