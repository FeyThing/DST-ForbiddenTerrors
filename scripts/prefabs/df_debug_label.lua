...
local function fn()
    ...
    inst.label_text = net_string(inst.GUID, "ia_debug_label.label_text", "label_textdirty")
    inst.label_text:set("")

    inst.label_uioffset = {
        x = net_float(inst.GUID, "ia_debug_label.label_uioffset.x", "label_uioffsetdirty"),
        y = net_float(inst.GUID, "ia_debug_label.label_uioffset.y", "label_uioffsetdirty"),
        z = net_float(inst.GUID, "ia_debug_label.label_uioffset.z", "label_uioffsetdirty"),
    }
    ...
    inst.label_colour = {
        r = net_float(inst.GUID, "ia_debug_label.label_colour.r", "label_colourdirty"),
        g = net_float(inst.GUID, "ia_debug_label.label_colour.g", "label_colourdirty"),
        b = net_float(inst.GUID, "ia_debug_label.label_colour.b", "label_colourdirty"),
        a = net_float(inst.GUID, "ia_debug_label.label_colour.a", "label_colourdirty"),
    }
...
return Prefab("df_debug_label", fn)
