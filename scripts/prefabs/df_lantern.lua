...
local function turnon(inst)
    if not inst.components.fueled:IsEmpty() then
        ...
        if inst._light == nil then
            inst._light = SpawnPrefab("df_lanternlight")
...
local function fn()
    ...
    inst.AnimState:SetBank("df_lantern")
    inst.AnimState:SetBuild("df_lantern")
    inst.AnimState:PlayAnimation("idle_off")
...
return Prefab("df_lantern", fn, assets, prefabs),
    Prefab("df_lanternlight", lanternlightfn)
