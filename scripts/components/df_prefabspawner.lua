...
local DF_WATERSPOT_NOSPAWN_ONEOF_TAGS = {"df_waterspot", "df_grass", "df_berrybush"}
...
local presets =
{
    df_driftwood = {
        ...
        spawncheckfn = function(x, y, z)
            return _map:IsSurroundedByDFOcean(x, y, z, 1.25) and
                    ...
                    #TheSim:FindEntities(x, y, z, 60, nil, nil, DF_DRIFTWOOD_NOSPAWN_ONEOF_TAGS) <= 0 and
    ...
    oceanfish_small_df = {
        ...
        spawncheckfn = function(x, y, z)
            return _map:IsSurroundedByDFOcean(x, y, z, 1.25) and
                    TheWorld.Map:GetPlatformAtPoint(x, z) == nil and
                    #TheSim:FindEntities(x, y, z, 60, nil, nil, DF_OCEANFISH_NOSPAWN_ONEOF_TAGS) <= 0 and
    ...
    df_unassuming_tree = {
        ...
        spawncheckfn = function(x, y, z)
            return _map:IsSurroundedByDFOcean(x, y, z, 1) and
                    #TheSim:FindEntities(x, y, z, 90, nil, nil, DF_WATERSPOT_NOSPAWN_ONEOF_TAGS) <= 0 and
