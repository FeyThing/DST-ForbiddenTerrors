...
local function addcanopyrow(widget,row)
    ...
    for i=1,#POS_INDEX do
        ...
        new_widget_AnimState:SetBank("evil_canopy")
        new_widget_AnimState:SetBuild("evil_canopy")
...
function Evilcanopy:OnUpdate(dt)
   if TheNet:IsServerPaused() then return end
    ...
    self.under_leaves = self.owner._underevilcanopy and self.owner._underevilcanopy:value()
